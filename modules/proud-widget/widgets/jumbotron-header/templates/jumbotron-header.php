<div class="jumbo-header jumbotron-header-container"><div class="<?php print implode( ' ', $classes ) ?>" id="<?php print $random_id ?>" style="<?php print implode( '', $arr_styles ) ?>"><!-- wp-proud-core/modules/proud-widget/widgets/jumbotron-header/templates/jumbotron-header.php -->
