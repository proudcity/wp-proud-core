...
<div class="card-columns card-columns-xs-2 card-columns-sm-2 <?php echo $class ?> card-columns-equalize"><!-- template-file: wp-proud-core/modules/proud-teasers/templates/image-cards.php -->
