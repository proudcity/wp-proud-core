...
class ShareLinks extends Core\ProudWidget {
  ...
  public function printWidget( $args, $instance ) {
    ...
    <!--<div class="dropdown share">-->
      <a<?php if( !empty( $instance['classes'] ) ) { echo ' class="' . $instance['classes'] .'"'; } ?> href="#" role="button" class="share-dropdown" id="share-<?php echo $args['widget_id'] ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i aria-hidden="true" class="fa fa-fw fa-share-alt"></i>Share</a>
      <ul class="dropdown-menu" aria-labelledby="share-<?php echo $args['widget_id'] ?>">
        <li><a title="Share on Facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php print urlencode($url); ?>" target="_blank"><i aria-hidden="true" class="fa fa-facebook-square fa-fw"></i> Facebook</a></li>
