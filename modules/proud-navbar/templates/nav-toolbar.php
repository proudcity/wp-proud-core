        ...
        <?php foreach ($action_buttons as $button) : ?>
            <li>
                ...
                if ($button['data_key'] && $button['data_key'] === 'google_translate') : ?>
                    <a href="#" id="translate" title="<?= $button['title'] ?>" data-proud-navbar class="<?= $button['classes'] ?>" aria-hidden="true" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
