...
D2026.03.03.1103escription2026.03.03.1103:        ProudCity distribution
Version:            2026.2026.03.03.110303.03.1103
Author:             ProudCity
...
class Proudcore extends \ProudPlugin
{
    ...
    public function init()
    {
        ...
        $this->addJsSettings(array('global' => array(
            ...
            'proudcity_site_id' => defined('APP') ? APP : (getenv('APP') ?: null), // @todo: remove this once we push live
            'url' => $url,
            'location' => array(
