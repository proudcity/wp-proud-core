...
<?php
    ...
    /**
     * If "Apply Action Button Color" is enabled in Form Settings,
     * injects the color_action_button theme mod as an inline background-color style
     * on the rendered submit button element.
     */
